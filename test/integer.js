...
describe("Integers", function() {
  [
    ...
    ["uint32be 0x7f000000", "uint32be", "7f000000", 32512],
    ["uint32be 0x7f000001", "uint32be", "7f000001", 32513],
    ["uint32be 0x7f00007f", "uint32be", "7f00007f", 32639],
    ["uint32be 0x7f0000ff", "uint32be", "7f0000ff", 32767],
    ["int32be 0x7f000000",  "int32be",  "7f000000", 32512],
    ["int32be 0x7f000001",  "int32be",  "7f000001", 32513],
    ["int32be 0x7f00007f",  "int32be",  "7f00007f", 32639],
    ["int32be 0x7f0000ff",  "int32be",  "7f0000ff", 32767],
    ["uint32be 0xff000000", "uint32be", "ff000000", 65280],
    ["uint32be 0xff000001", "uint32be", "ff000001", 65281],
    ["uint32be 0xff00007f", "uint32be", "ff00007f", 65407],
    ["uint32be 0xff0000ff", "uint32be", "ff0000ff", 65535],
    ...
    ["uint32le 0x0000007f", "uint32le", "0000007f", 32512],
    ["uint32le 0x0100007f", "uint32le", "0100007f", 32513],
    ["uint32le 0x7f00007f", "uint32le", "7f00007f", 32639],
    ["uint32le 0xff00007f", "uint32le", "ff00007f", 32767],
    ["int32le 0x0000007f",  "int32le",  "0000007f", 32512],
    ["int32le 0x0100007f",  "int32le",  "0100007f", 32513],
    ["int32le 0x7f00007f",  "int32le",  "7f00007f", 32639],
    ["int32le 0xff00007f",  "int32le",  "ff00007f", 32767],
    ["uint32le 0x000000ff", "uint32le", "000000ff", 65280],
    ["uint32le 0x010000ff", "uint32le", "010000ff", 65281],
    ["uint32le 0x7f0000ff", "uint32le", "7f0000ff", 65407],
    ["uint32le 0xff0000ff", "uint32le", "ff0000ff", 65535],
